import { AlertCircle, Calendar, FileText, DollarSign, CheckCircle, ExternalLink, ChevronDown } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '../components/ui/card';
import { Alert, AlertDescription, AlertTitle } from '../components/ui/alert';
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '../components/ui/accordion';
import { Button } from '../components/ui/button';

export function AITaxAssistance() {
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-5xl">
        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-6">
              ...
              <AccordionContent className="text-sm text-muted-foreground">
                Yes, file Form 4868 by the original deadline to get an automatic 6-month extension. 
                Note: An extension to file is not an extension to pay. 
                Estimate and pay any taxes owed by the original deadline to avoid interest and penalties.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </CardContent>
      ...
      <Alert className="border-muted bg-muted/20">
        ...
        <AlertDescription className="text-xs text-muted-foreground">
          This guidance is for informational purposes only. Tax laws change frequently. 
